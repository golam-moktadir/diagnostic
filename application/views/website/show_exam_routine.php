...
<div class="container" style="color: black; width: 100%; padding: 0px 50px;">
    <div class="box box-info">
        <div class="box-header">
            <h3 class="box-title">Exam Routine</h3>                                    
        </div>
            ...
            <table id="example2" class="table table-bordered table-hover">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Exam Routine</th>
                    ...
                    foreach ($all_value as $single_value) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="<?php echo base_url(); ?>assets/pdf/exam_routine/<?php echo $single_value->pdf; ?>" 
