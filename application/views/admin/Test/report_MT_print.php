                        ...
                        <h4>
                            <div class="row">
                                <div class="col-md-2 col-xs-2">
                                    <?php if (file_exists('./assets/img/barcode/LIV' . $test_id . '.jpg')) { ?>
                                        <img src="<?php echo base_url(); ?>assets/img/barcode/<?php echo "LIV" . $test_id . '.jpg'; ?>"
                                              style='height: 40px; width: 70%;'>

                                    <?php } ?>
                                </div>
                                <div class="col-md-8 col-xs-8" style="text-align: center; margin: 10px;"><b style="border: 2px solid black; padding: 5px;">MANTOUX TEST</b></div>
                            ...
                            <table id="purchaseList" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: center; font-size: 20px;">Mantoux Test(MT)</td>
                                        <td style="text-align: center;font-size: 20px;"><?php echo $test_res[0]->MT; ?></td>
                                    </tr>
<!--                                    <tr style="text-align: left; font-weight: bolder;">
                                        <td style="text-align: center;">Comment</td>
                                        <td style="text-align: center;"><?php echo $test_res[0]->comment; ?></td>
                                    </tr>-->
                                </tbody>   
                            </table>
                        </div>
