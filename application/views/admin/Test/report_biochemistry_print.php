...
<!--                                    <tr style="text-align: left; font-weight: bolder;">
                                    ...
                                    <?php if ($test_res[0]->bl_gl_fa_sugar != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Corresponding Urine Sugar (Fasting)</td>
                                    ...
                                    <?php if ($test_res[0]->bl_gl_2h_sugar != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Corresponding Urine Sugar (Random)</td>
                                    ...
                                    <?php if ($test_res[0]->bl_gl_1h_75_sugar != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Corresponding Urine Sugar (1hour’s after 75 gm glucose)</td>
                                    ...
                                    <?php if ($test_res[0]->bl_gl_2h_75_sugar != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Corresponding Urine Sugar (2hour’s after 75 gm glucose)</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->bl_gl_2h_75_sugar; ?></td>
                                            <td style="text-align: center;">Nil</td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($test_res[0]->cor_2habf != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Corresponding (2HABF)</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->cor_2habf; ?></td>
                                            <td style="text-align: center;">Nil</td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($test_res[0]->bd_glucose != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Blood glucose (2HABF)</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->bd_glucose; ?> mmol/l</td>
                                            <td style="text-align: center;"> 7.8-11.5 mmol/l</td>
                                        </tr>
                                    <?php } ?>
                                    ...
                                    <?php if ($test_res[0]->sopt != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            ...
                                            <td style="text-align: center;">Up to 37.0 u/l</td>
                                        </tr>
                                    <?php } ?>
                                    ...
                                    <?php if ($test_res[0]->urea_nitrogen != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            ...
                                            <td style="text-align: center;"><?php echo $test_res[0]->urea_nitrogen; ?> mg/dl</td>
                                            <td style="text-align: center;">7.5 – 18.0 mg/dl</td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($test_res[0]->se_albumin != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Serum Albumin</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->se_albumin; ?> g/dl</td>
                                            <td style="text-align: center;">3.5 – 5.8 g/dl</td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($test_res[0]->se_globulin != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Serum Globulin</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->se_globulin; ?> g/dl</td>
                                            <td style="text-align: center;">1.6 - 3.5 g/dl</td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($test_res[0]->se_protein != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Serum Protein</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->se_protein; ?> g/dl</td>
                                            <td style="text-align: center;">5.5 - 8.0 g/dl</td>
                                        </tr>
                                    <?php } ?>
                                    <?php if ($test_res[0]->se_lipase != "") { ?>
                                        <tr style="text-align: center; font-weight: bolder;">
                                            <td style="text-align: left;">Serum Lipase</td>
                                            <td style="text-align: center;"><?php echo $test_res[0]->se_lipase; ?> u/l</td>
                                            <td style="text-align: center;">0 – 160 u/l</td>
                                        </tr>
                                    <?php } ?>
