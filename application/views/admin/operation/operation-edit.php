        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable"> 
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;" class="no_print">
                    ...
                    <h5 class="text-center text-info">Operation Name Edit Form</h5>
                    <div class="box-body">
                        <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <select name="category_id" id="category_id" class="form-control">
                                ...
                                <?php foreach ($categories as $category) { ?>
                                    <option <?php if($category->record_id == $name->category_id) echo 'selected' ?> value="<?php echo $category->record_id; ?>">
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                            ...
                            <input type="text" class="form-control" id="operation_name" value="<?php echo $name->operation_name ?>" name="operation_name">
                        </div>
                        <div class="form-group col-sm-3 col-xs-12">
                            <label for="rate">Rate</label>
                            <input type="number" class="form-control" id="rate" value="<?php echo $name->rate ?>" name="rate">
                            <input type="hidden" name="record_id" value="<?php echo $name->record_id ?>">
                        </div>
                    </div>
                    <div class="clearfix" style="margin-top: 17px;">
                        <button type="submit" class="pull-left btn btn-success" style="margin-top: 26px;" name="update" value="update">Update <i class="fa fa-arrow-circle-right"></i></button>
                    </div>
                    </form>
                </div>
