...
foreach($one_value as $one_info){
    ...
    $child_name = $one_info->child_name;
        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div class="box box-info" style="color: black;">
                    <?php echo form_open_multipart('Edit/birth_report/'.$record_id); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Edit Birth Report</p>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4 col-xs-12" style="">
                             ...
                             <div class="form-group col-sm-4 col-xs-12" style="">
                                ...
                                <input type="text" class="form-control" id="child_name" placeholder="" name="child_name" value="<?php echo $child_name; ?>">
                            </div>
                            <div class="form-group col-sm-4 col-xs-12" style="">
