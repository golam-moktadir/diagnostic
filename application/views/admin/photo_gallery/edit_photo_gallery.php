        ...
        <div class="row" style="margin-top: 55px;">
            <section class="col-xs-12 connectedSortable">
                <div class="" style="color: black;">
                    <?php echo form_open_multipart('Edit/photo_gallery/'.$photo->record_id) ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Edit Photo.</p>
                        <div class="row">
                            ...
                            <div class="box-footer col-xs-3 clearfix">
                                <button style="margin-top: 27px" type="submit" class="pull-left btn btn-success">Update <i
