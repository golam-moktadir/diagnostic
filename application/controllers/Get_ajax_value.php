...
//echo $response;
    ...
    public function get_honorarium_report_info() {
        ...
        $data['end_date'] = $date_to;
        if (!empty($doctor)) {
            $data['all_value'] = $this->Common_model->doc_commission_doc($date_from, $date_to, $doctor);
        } else {
            $data['all_value'] = $this->Common_model->doc_commission_without_doc($date_from, $date_to);
        }
