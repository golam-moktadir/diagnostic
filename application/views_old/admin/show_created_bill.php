<div class="box-body table-responsive" style="width: 98%; color: black;">
    <div class="row" id="no_print2">
        <div class="form-group col-sm-3 col-xs-12">
            ...
            <input type="text" name="due" id="due" value="<?php echo $due; ?>" class="form-control" readonly>
        </div>
        <div class="form-group col-sm-3 col-xs-12">
            ...
            <tr>
                <th colspan="8">
                    <p style="text-align: center; font-weight: bold;">
                        Client Name: <?php echo $patient_name; ?>
                    </p>
                </th>
            </tr>
            <tr>
...
<script type="text/javascript">
    ...
    $('#pay_btn').on('click', function (e) {
        ...
        var post_data = {
            'paid': paid, 'search_client': search_client, 'final_due': final_due,
