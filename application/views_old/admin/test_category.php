        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable"> 
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;" class="no_print">
                    <?php echo form_open_multipart('Insert/test_category'); ?>
                    <div class="box-body">
                        <!--<p style="font-size: 20px;">Create Test Category</p>-->
                        <p  style="font-size: 20px; color: #066;"><?php echo $msg; ?></p>
                        <div class="form-group" style="width: 400px;">
                            <label for="test_category">Test Category</label>
                            <input type="text" class="form-control" id="test_category" placeholder="" name="test_category">
                        </div>
                    </div>
                ...
                <div>
                    <div>
                        <h4 style="color: blue; text-align: center;">Test Category Info.</h4>                               
                    </div>
...
<!--                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" class="btn btn-danger"
                                               href="<?php echo base_url(); ?>Delete/create_test_category/<?php echo $single_value->record_id; ?>">Delete
                                            </a>
                                        </td>-->
                                    </tr>
                                <?php } ?>
