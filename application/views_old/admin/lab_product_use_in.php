        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable"> 
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;" class="no_print">
                    <?php echo form_open_multipart('Insert/lab_product_use_in'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px; color: green; font-weight: bold; text-align: center;">Lab Stock(IN)</p>
                ...
                <div>
                    <div>
                        <h4 style="color: blue; text-align: center;">Lab Stock(IN) Info.</h4>                               
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a style="margin: 5px;" class="btn btn-danger"
                                               href="<?php echo base_url(); ?>Delete/lab_product_use_in/<?php echo $single_value->record_id; ?>">Delete
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
...
<script type="text/javascript">
    window.onload = function () {
        $("#total_qty, #unit_price").on("change paste keyup", function () {
            ...
            if (total_qty == "" || total_qty == 0) {
             ...
             var total_price = Number(total_qty * unit_price).toFixed(2);
