                        ...
                        success: function (data) {
                            ...
                            try {
                                ...
                                $("#example1").dataTable({
                                    ...
                                    "bSort": false,
                                    "aoColumns": [
                                        {"mDataProp": "sl"}, {"mDataProp": "date"}, {"mDataProp": "asset"}, {"mDataProp": "sub_category"}, {"mDataProp": "credit_debit"}, {"mDataProp": "asset_from"}, {"mDataProp": "quantity"}, {"mDataProp": "amount"}
                                    ],
                                    "scrollX": true,
                                    dom: 'Bfrtip',
                                    buttons: [{
                ...
                <aside class="profile-info col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body bio-graph-info">
                            ...
                            ?>
                            <h1> Search Asset Information </h1>
                            <hr>
                            <hr>
                ...
                <aside class="profile-info col-lg-12">
                    <section class="panel">
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border">Asset</legend>
