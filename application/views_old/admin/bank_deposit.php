        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable"> 
                <div class="box box-info" style="color: black;">
                    <?php echo form_open_multipart('Insert/bank_deposit'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Bank Deposit</p>
                        ...
                        <div class="form-group col-sm-3 col-xs-12">
                            <label for="amount">Deposit Amount</lab
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">Carry By</th>
...
<!--                                            <a style="margin: 5px;" class="btn btn-info"
                                            ...
                                            <a style="margin: 5px;" class="btn btn-danger"
                                               href="<?php echo base_url(); ?>Delete/bank_deposit/<?php echo $single_value->record_id; ?>">Delete
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
