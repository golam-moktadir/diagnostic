        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div class="box box-info" style="color: black;">
                    <?php echo form_open_multipart('Insert/investigation_report'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px;">Add Investigation Report</p>
                                ...
                                foreach ($all_value as $single_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <img src="<?php echo base_url(); ?>assets/img/investigation_report/<?php echo $single_value->image; ?>"
                                                 width="50" height="50">
                                        </td>
                                        ...
                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" class="btn btn-info"
                                               href="<?php echo base_url(); ?>Show_edit_form/investigation_report/<?php echo $single_value->record_id; ?>/main">Edit
                                            </a>
                                            <a style="margin: 5px;" class="btn btn-danger"
                                               href="<?php echo base_url(); ?>Delete/investigation_report/<?php echo $single_value->record_id; ?>">Delete
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
