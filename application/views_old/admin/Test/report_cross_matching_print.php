                        ...
                        <h4>
                            <div class="row">
                                <div class="col-md-2 col-xs-2">
                                    <?php if (file_exists('./assets/img/barcode/CRO' . $test_id . '.jpg')) { ?>
                                        <img src="<?php echo base_url(); ?>assets/img/barcode/<?php echo "CRO" . $test_id . '.jpg'; ?>"
                                              style='height: 40px; width: 70%;'>

                                    <?php } ?>
                                </div>
                                <div class="col-md-8 col-xs-8" style="text-align: center; margin: 10px;"><b style="border: 2px solid black; padding: 5px;">BLOOD GROUP EXAMINATION REPORT</b></div>
                            ...
                            <table id="purchaseList" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: left;">Patient Blood Group</td>
                                        <td style="text-align: center;"><?php echo $test_res[0]->ABO_group; ?></td>
                                    </tr>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: left;">Patient Rh-Factor</td>
                                        <td style="text-align: center;"><?php echo $test_res[0]->Rh_type; ?></td>
                                    </tr>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: left; color: #003399 !important;" colspan="2"><?php echo $test_res[0]->cross_matching; ?></td>
                                    </tr>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: left;" colspan="2">
                                            Donor's Name: <?php echo $test_res[0]->doner_name; ?><b style="padding-left: 50px;"></b>Donor's Age: <?php echo $test_res[0]->age_d; ?> 
                                            <b style="padding-left: 50px;"></b>Donor's Sex: <?php echo $test_res[0]->sex_d; ?></td>
                                    </tr>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: left;">Donor's Blood Group</td>
                                        <td style="text-align: center;"><?php echo $test_res[0]->doner_abo; ?></td>
                                    </tr>
                                    <tr style="text-align: center; font-weight: bolder;">
                                        <td style="text-align: left;">Donor's Rh-Factor</td>
                                        <td style="text-align: center;"><?php echo $test_res[0]->rh_types; ?></td>
                                    </tr>

                                    <tr style="text-align: left; font-weight: bolder;">
                                        <td style="text-align: left; color: #003399 !important;" colspan="2">Screening Test: <?php echo $test_res[0]->scr_test; ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
