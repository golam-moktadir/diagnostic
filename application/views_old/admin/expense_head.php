        ...
        <div class="row">
            <section class="col-xs-12 connectedSortable">
                <div style="color: black; background: #a6d7ff; padding: 8px; border: 2px solid #055d9c; margin-bottom:5px;" class="no_print">
                    <?php echo form_open_multipart('Insert/expense_head'); ?>
                    <div class="box-body">
                        <p style="font-size: 20px; color: green; font-weight: bold; text-align: center;">Create Expense Head</p>
                        <p style="font-size: 20px; color: #066;"><?php echo $msg; ?></p>

                        <div class="row">
                            <div class="form-group col-sm-4 col-xs-12">
                                <label for="expense_head">Expense Head</label>
                                <input type="text" name="expense_head" id="expense_head"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div>
                        <h4 style="color: blue; text-align: center;">Expense Head Info.</h4>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a style="margin: 5px;" class="btn btn-danger"
                                               href="<?php echo base_url(); ?>Delete/expense_head/<?php echo $single_value->record_id; ?>">Delete
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
