...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2020 at 06:26 PM
...
INSERT INTO `admission_patient` (`record_id`, `patient_id`, `category_id`, `operation_id`, `doctor_id`, `anesthesia_id`, `diagnosis`, `relation`, `admission_date`, `operation_date`, `advance_fee`) VALUES
(2, 281, 24, 138, 32, 22, 'vsda', 'none', '2020-07-22', '2020-07-22', 200),
(3, 281, 21, 140, 48, 23, 'abc', 'none', '2020-07-12', '2020-07-30', 300),
(4, 277, 23, 141, 43, 22, 'nbvcc', 'none', '2020-07-22', '2020-07-25', 500);
...
--
-- Table structure for table `operation_invoice`
--

CREATE TABLE `operation_invoice` (
  `record_id` int(11) NOT NULL,
...
--
-- Dumping data for table `operation_invoice`
--

INSERT INTO `operation_invoice` (`record_id`, `admission_id`, `patient_id`, `operation_id`, `operation_price`, `discount`, `payable_amount`, `due`) VALUES
(2, 3, 281, 140, 15000, 300, 12000, 2400),
(3, 2, 281, 138, 500, 10, 200, 90),
(4, 4, 277, 141, 5000, 1000, 3500, 0);
...
--
-- Indexes for table `operation_invoice`
--
ALTER TABLE `operation_invoice`
  ADD PRIMARY KEY (`record_id`);
...
--
-- AUTO_INCREMENT for table `operation_invoice`
--
ALTER TABLE `operation_invoice`
  MODIFY `record_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
